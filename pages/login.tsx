...
function LoginScreen() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    axios
      .post(`${baseUrl}/api/users/login`, inputs)
      .then((res) => {
        setIsLoading(false);
      ...
      .catch((err) => {
        setIsLoading(false);
        errorTag.textContent = err.response
        ...
        <div className={styles.formWrapper}>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <p>
              ...
              <Link href="/register">
                <a style={{ color: "blue", fontWeight: "bold" }}>Register</a>
              </Link>
            </p>
...
export default dynamic(() => Promise.resolve(LoginScreen), {
  ssr: false,
